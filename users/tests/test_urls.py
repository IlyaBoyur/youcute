...
class UsersURLTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        user_other = User.objects.create_user(username=USER_NAME_OTHER)
        ...
        cls.authorized_client_with_profile.force_login(user_other)
    ...
    def test_urls_use_correct_template(self):
        ...
        url_templates = [
            [PROFILE_CREATE_URL, self.guest_client, "profile_new.html"],
            [PROFILE_EDIT_URL, self.guest_client, "profile_new.html"],
        ]
